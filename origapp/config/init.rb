...
dependencies 'dm-types', 'dm-validations', 'dm-serializer'
Merb::BootLoader.after_app_loads do
  # Add dependencies here that must load after the application loads:
  require "merb/session/data_mapper_session"
  Merb::DataMapperSession.send(:include, Authentication::Session) unless Merb::DataMapperSession > Authentication::Session
